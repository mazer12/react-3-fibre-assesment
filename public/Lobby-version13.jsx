...
Command: npx gltfjsx@6.2.16 lobby-version13.glb --transform 
Files: lobby-version13.glb [32.11MB] > E:\react 3 fibre example\public\lobby-version13-transformed.glb [3.39MB] (89%)
*/
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <mesh name="21jumpStreet_interaction_v1" geometry={nodes['21jumpStreet_interaction_v1'].geometry} material={materials['21jumpStreet_interaction_v1']} position={[27.177, 9.3, 16.153]} rotation={[Math.PI / 2, 0, 0]} scale={0.29} />
        <mesh name="backToFuture_interaction_v1" geometry={nodes.backToFuture_interaction_v1.geometry} material={materials.backToFuture_interaction_v1} position={[24.654, 5.737, 15.246]} rotation={[Math.PI / 2, 0, 0]} scale={0.29} />
        <mesh name="badBoys_interaction_v1" geometry={nodes.badBoys_interaction_v1.geometry} material={materials.badBoys_interaction_v1} position={[25.379, 9.3, 16.153]} rotation={[Math.PI / 2, 0, 0]} scale={0.29} />
        <mesh name="bohemianRhapsody_interaction_v1" geometry={nodes.bohemianRhapsody_interaction_v1.geometry} material={materials.bohemianRhapsody_interaction_v1} position={[28.991, 9.3, 16.153]} rotation={[Math.PI / 2, 0, 0]} scale={0.29} />
        <mesh name="fordVFerrari_interaction_v1" geometry={nodes.fordVFerrari_interaction_v1.geometry} material={materials.fordVFerrari_interaction_v1} position={[30.795, 9.3, 16.153]} rotation={[Math.PI / 2, 0, 0]} scale={0.29} />
        <mesh name="gunShy_interaction_v1" geometry={nodes.gunShy_interaction_v1.geometry} material={materials.gunShy_interaction_v1} position={[32.58, 9.3, 16.153]} rotation={[Math.PI / 2, 0, 0]} scale={0.29} />
        <mesh name="interstellar_interaction_v1" geometry={nodes.interstellar_interaction_v1.geometry} material={materials.interstellar_interaction_v1} position={[34.395, 9.3, 16.153]} rotation={[Math.PI / 2, 0, 0]} scale={0.29} />
        <mesh name="kolya_interaction_v1" geometry={nodes.kolya_interaction_v1.geometry} material={materials.kolya_interaction_v1} position={[37.225, 9.3, 17.338]} rotation={[1.572, 0, 1.573]} scale={0.29} />
        <mesh name="lebanon_interaction_v1" geometry={nodes.lebanon_interaction_v1.geometry} material={materials.lebanon_interaction_v1} position={[37.225, 9.3, 19.062]} rotation={[1.572, 0, 1.573]} scale={0.29} />
        <mesh name="likeWater4Chocolate_interaction_v1" geometry={nodes.likeWater4Chocolate_interaction_v1.geometry} material={materials.likeWater4Chocolate_interaction_v1} position={[37.225, 9.3, 20.788]} rotation={[1.572, 0, 1.573]} scale={0.29} />
        <mesh name="madMaxFuryRoad_interaction_v1" geometry={nodes.madMaxFuryRoad_interaction_v1.geometry} material={materials.madMaxFuryRoad_interaction_v1} position={[37.225, 9.3, 22.506]} rotation={[1.572, 0, 1.573]} scale={0.29} />
        <mesh name="mr&MrsSmith_interaction_v1" geometry={nodes['mr&MrsSmith_interaction_v1'].geometry} material={materials['mr&MrsSmith_interaction_v1']} position={[37.225, 9.3, 25.97]} rotation={[1.572, 0, 1.573]} scale={0.29} />
        <mesh name="theGodfather_interaction_v1" geometry={nodes.theGodfather_interaction_v1.geometry} material={materials.theGodfather_interaction_v1} position={[37.686, 5.872, 17.394]} rotation={[1.572, 0, 1.573]} scale={0.29} />
        <mesh name="theShining_interaction_v1" geometry={nodes.theShining_interaction_v1.geometry} material={materials.theShining_interaction_v1} position={[37.686, 5.872, 19.434]} rotation={[1.572, 0, 1.573]} scale={0.29} />
        <mesh name="manOnFire_interaction_v1" geometry={nodes.manOnFire_interaction_v1.geometry} material={materials.manOnFire_interaction_v1} position={[37.225, 9.307, 24.231]} rotation={[1.572, 0, 1.573]} scale={0.29} />
        <mesh name="scriptBoard_interaction_v1" geometry={nodes.scriptBoard_interaction_v1.geometry} material={materials.scriptBoard_interaction_v1} position={[29.185, 5.613, 15.362]} rotation={[Math.PI / 2, 0, 0]} scale={0.29} />
        ...
        <mesh name="EyeLeft002" geometry={nodes.EyeLeft002.geometry} material={materials.Wolf3D_Eye} position={[34.896, 3.863, 28.231]} rotation={[Math.PI / 2, 0, 1.392]} scale={0.01} />
        <mesh name="EyeRight002" geometry={nodes.EyeRight002.geometry} material={materials.Wolf3D_Eye} position={[34.896, 3.863, 28.231]} rotation={[Math.PI / 2, 0, 1.392]} scale={0.01} />
        <mesh name="Wolf3D_Head001" geometry={nodes.Wolf3D_Head001.geometry} material={materials.Wolf3D_Skin} position={[34.896, 3.863, 28.231]} rotation={[Math.PI / 2, 0, 1.392]} scale={0.01} />
        <mesh name="Wolf3D_Teeth001" geometry={nodes.Wolf3D_Teeth001.geometry} material={materials.Wolf3D_Teeth} position={[34.896, 3.863, 28.231]} rotation={[Math.PI / 2, 0, 1.392]} scale={0.01} />
      </group>
    </group>
  )
}

useGLTF.preload('/lobby-version13-transformed.glb')
